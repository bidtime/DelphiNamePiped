...
type
    ...
    public
        ...
        destructor Destroy; override;
        function Broadcast(const S: string): Boolean; overload;
...
function TPipeServer.Broadcast(const S: string): Boolean;
begin
  Result := Broadcast(Pointer(S)^, Length(S) * SizeOf(Char));
end;
